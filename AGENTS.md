...
**현재 포트폴리오 (공격형, DC형 70% 한도 준수, v1.4)**:
| 펀드 | 유형 | 비중 | 총보수 | 위험자산 | 역할 |
|------|:----:|:----:|:------:|:--------:|:----:|
| 신한미국S&P500인덱스UH | 해외주식 | 20% | 0.60% | O | Core |
| 삼성글로벌반도체UH | 해외주식 | 20% | 1.27% | O | Core |
| 미래에셋연금한국헬스케어 | 주식 | 10% | 1.62% | O | Satellite |
| 미래에셋퇴직연금배당커버드콜 | 주식혼합 | 10% | 0.62% | O | Satellite |
| KB스타베트남VN30인덱스 | 해외주식 | 5% | 0.50% | O | Satellite |
| 삼성글로벌휴머노이드로봇UH | 해외주식 | 5% | 1.29% | O | Satellite |
| 한국투자크레딧포커스ESG(채권) | 채권 | 15% | 0.291% | X | Safe |
| 키움더드림단기채(채권) | 채권 | 15% | 0.175% | X | Safe |
| **위험자산 합계** | | **70%** | | | |
| **안전자산 합계** | | **30%** | | | |
| **가중평균 총보수** | | | **~0.67%** | | |

**v1.4 변경 이력 (2026-01-28)**:
- S&P500: 삼성 → 신한 (펀드사 변경)
- 반도체: 15% → 20% (+5%)
- 필승코리아 10% → 제외
- 배당커버드콜: 20% → 10% (-10%)
